...
*/
function ptv_get_mainContent_width($sidebar_left, $sidebar_right) {
  $width = 530;
  if (!$sidebar_left) {
    $width = $width + 180;
  }
...
function ptv_get_sideBars_width($sidebar_left, $sidebar_right) {
  $width = 415;
  if (!$sidebar_left) {
   $width = $width - 205;
  }
...
/*
function ptv_get_primaryContent_width($sidebar_left, $sidebar_right) {
  $width = '36.5';
  if (!$sidebar_left) {
    $width = $width + '24';
  }  
...
/*
function ptv_get_sidebarsContent_margin($search_box) {
  $margin = 0;
  if ($search_box) {
    $margin = '20px 0 0 0';
  }
...
/*
function ptv_links($links, $attributes = array('class' => 'links')) {
  $output = '';
